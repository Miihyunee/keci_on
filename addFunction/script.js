...
function generatePDF() {
    ...
    const naturalW = Math.max(rosterTable ? rosterTable.scrollWidth : 0, PDF_MIN_CAPTURE_W) + 24;
    ...
    const captureW = Math.max(target.scrollWidth, naturalW) + 16;
